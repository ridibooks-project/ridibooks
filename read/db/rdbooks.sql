...
) ENGINE=InnoDB AUTO_INCREMENT=83 DEFAULT CHARSET=utf8mb3 COMMENT='회원정보 테이블';

-- 테이블 데이터 rdbooks.memberinfo:~9 rows (대략적) 내보내기
...
INSERT INTO `memberinfo` (`id_no`, `member_id`, `member_email`, `member_pw`, `member_name`, `year`, `gender`, `marketing_agree`, `select_agree`, `signup_date`, `login_date`, `cash`, `point`, `m_status`) VALUES
	(1, 'id0001', 'id0001@naver.com', 'VfK20RQB97', '홍길동', NULL, NULL, 'N', 'N', '2021-12-30 00:00:00', '2022-01-18 23:42:35', 0, 0, 0),
	(3, 'id0002', 'id0002@naver.com', 'qwe123!!', '두번째', NULL, NULL, 'Y', 'Y', '2022-01-09 23:45:22', '2022-01-17 00:19:54', 0, 0, 0),
	...
	(82, 'leesol01', 'leesol01@naver.com', 'qwe123!!', '이솔', NULL, NULL, 'N', 'N', '2022-01-18 23:27:12', NULL, 0, 0, 0);
